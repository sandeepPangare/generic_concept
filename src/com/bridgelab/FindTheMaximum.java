...
public class FindTheMaximum<T extends Comparable> {
    // create generics maximumValue method and passing parameters
    ...
    public static void main(String[] args) {
        ...
        FindTheMaximum max = new FindTheMaximum(); // creating object for FindMaximum class object name is max
